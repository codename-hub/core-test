...
abstract class base extends TestCase
{
     ...
     */
    protected static function setEnvironmentConfig(array $config): void
    {
     ...
     * @return void
     */
    protected static function createModel(string $schema, string $model, array $config, ?callable $initFunction = null): void
    {
        static::$models[$model] = [
          'schema' => $schema,
          'model' => $model,
     ...
     * @throws exception
     */
    protected static function architect(string $app, string $vendor, string $envName): void
    {
        $dbDoc = new overrideableDbDoc($app, $vendor);
        $architectEnv = new environment(app::getEnvironment()->get(), $envName);
        ...
        $dbDoc->run(true, [task::TASK_TYPE_REQUIRED]);
        $dbDoc->run(true, [task::TASK_TYPE_SUGGESTED]);
    }
     ...
     * @throws exception
     */
    protected static function getModelStatic(string $model): model
    {
